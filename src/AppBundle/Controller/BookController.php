...
class BookController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('book_show', array('name' => $book->getName()));
        }
     ...
     *
     * @Route("/{name}", name="book_show")
     * @Method("GET")
     */
    public function showAction(Book $book)
    {
        foreach ($book->getGenres() as $value) {
          $this->denyAccessUnlessGranted($value->getRole(), null, 'Unable to access this page!');
        }
